...
public class GlobalControllerExceptionHandler {
    ...
    public ErrorResponse handleBadRequestException(MethodArgumentConversionNotSupportedException exception) {
     ...
     * @return Example
     */
    private ErrorResponse getErrorResponse(String title, int statusCode, String detail, Exception exception) {
